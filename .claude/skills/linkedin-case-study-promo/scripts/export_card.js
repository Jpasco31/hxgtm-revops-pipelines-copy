#!/usr/bin/env node
/*
 * linkedin-case-study-promo - Puppeteer PNG exporter
 *
 * Renders a 1080x1080 case-study promo LinkedIn card HTML and screenshots
 * ONLY the .card element. Saves both 1x and 2x PNG files.
 *
 * Usage:
...
async function run() {
  ...
  try {
    ...
    console.error('  cd ".claude/skills/linkedin-case-study-promo/scripts"');
