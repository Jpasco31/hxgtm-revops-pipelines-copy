# Channel Playbooks — Raw Source Index

Ingest tracking for the **Channel Playbooks** group. Owned by **Channel Playbooks**.

Each row represents a raw source file staged under `raw/channel-playbooks/`.
...
| Column | Meaning |
|---|---|
| **File** | Path relative to `raw/channel-playbooks/` (e.g. `notions/foo.md`) |
