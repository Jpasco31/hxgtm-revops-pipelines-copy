# Company Overview & Narrative — Raw Source Index

Ingest tracking for the **Company Overview & Narrative** group. Owned by
**Company Overview & Narrative**.

Each row represents a raw source file staged under `raw/company-overview/`.
...
| Column | Meaning |
|---|---|
| **File** | Path relative to `raw/company-overview/` (e.g. `notions/foo.md`) |
...
|---|---|---|---|
| notions/Workbench-maybe.md | 2026-04-15 |  | yes |
