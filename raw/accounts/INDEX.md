# Account & Opp-level Context — Raw Source Index

Ingest tracking for the **Account & Opp-level Context** group. Owned by
**Account & Opp-level Context**.

Each row represents a raw source file staged under `raw/accounts/`. This
...
| Column | Meaning |
|---|---|
| **File** | Path relative to `raw/accounts/` (e.g. `notions/foo.md`) |
