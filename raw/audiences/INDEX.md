# Audiences & Personas — Raw Source Index

Ingest tracking for the **Audiences & Personas** group. Owned by
**Audiences & Personas**.

Each row represents a raw source file staged under `raw/audiences/`. This
...
| Column | Meaning |
|---|---|
| **File** | Path relative to `raw/audiences/` (e.g. `notions/foo.md`) |
