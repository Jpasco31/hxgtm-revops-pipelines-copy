# RFP Responses — Raw Source Index

Ingest tracking for the **RFP Responses** group. Owned by
**RFP Responses**.

Each row represents a raw source file staged under `raw/rfp/`. This index
tracks when files arrived, when kb-update last processed them, and whether
...
| Column | Meaning |
|---|---|
| **File** | Path relative to `raw/rfp/` (e.g. `notions/foo.md`) |
