# Company Policies & Platform Commitments — Raw Source Index

Ingest tracking for the **Company Policies & Platform Commitments** group.
Owned by **Company Policies & Platform Commitments**.

Each row represents a raw source file staged under `raw/company-policies/`.
...
| Column | Meaning |
|---|---|
| **File** | Path relative to `raw/company-policies/` (e.g. `notions/foo.md`) |
