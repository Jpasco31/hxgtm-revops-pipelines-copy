...
description: >
  ...
  findings document using the hyperexponential brand. Trigger when the user says things like
  "build me a report", "generate a PDF", "produce a report on X", "write up our findings
  as a PDF", "create a branded report", or asks to turn analysis/data into a shareable
  document. The skill bundles the complete hx brand system (Acid Grotesk fonts, brand
